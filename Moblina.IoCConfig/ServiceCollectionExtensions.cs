...
namespace Moblina.IoCConfig
{
    public static class ServiceCollectionExtensions
    {
        public static void AddCustomDataAccess(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddDbContext<MoblinaContext>(config =>
            {
                config.UseSqlServer(
                    configuration.GetConnectionString("MoblinaConnectionString"),
            ...
            services.AddScoped<IUnitOfWork, MoblinaContext>();
        }
